...
| **Sprint 12** | Operations Platform 2.0 | Dev complete · AI **동결** · GA (`v1.12.0`) |
| **Sprint 13** | **Game Launch & Retention** — Pinball·Connect4·Water Sort·Mahjong **출시 패키지** | PLANNED — [`docs/sprint-13-plan.md`](docs/sprint-13-plan.md) · PM ✅ |
...
> - Sprint 13+ = **게임 출시 패키지 + 리텐션** (Epic: Launch · NEW badge · Game Analytics 6) — PM Review 2026-07-24 ✅
