# Bubble Shooter — Operation Guide
...
- Daily: 카테고리(casual) 플레이 미션 자동 연동
...
| Check | How | Expected |
| --- | --- | --- |
| Load | `GET /games/bubble-shooter` | 200 |
| Play | 1판 완료 | 점수/결과 표시 |
...
- Review Card: [`../reports/game-reviews/bubble-shooter-2026-07.md`](../reports/game-reviews/bubble-shooter-2026-07.md)
