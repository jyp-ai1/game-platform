...
- Daily: 카테고리(arcade) 플레이 미션 자동 연동
...
| Check | How | Expected |
| --- | --- | --- |
| Load | `GET /games/whack-a-mole` | 200 |
| Play | 1판 완료 | 점수/결과 표시 |
...
- Review Card: [`../reports/game-reviews/whack-a-mole-2026-07.md`](../reports/game-reviews/whack-a-mole-2026-07.md)
