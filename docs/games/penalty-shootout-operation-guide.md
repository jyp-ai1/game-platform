# Penalty Shootout — Operation Guide
...
- Daily: 카테고리(sports) 플레이 미션 자동 연동
...
| Check | How | Expected |
| --- | --- | --- |
| Load | `GET /games/penalty-shootout` | 200 |
| Play | 1판 완료 | 점수/결과 표시 |
...
- Review Card: [`../reports/game-reviews/penalty-shootout-2026-07.md`](../reports/game-reviews/penalty-shootout-2026-07.md)
