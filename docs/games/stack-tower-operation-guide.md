...
| Check | How | Expected |
| --- | --- | --- |
| Load | `GET /games/stack-tower` | 200 |
| Play | 1판 완료 | 점수/결과 표시 |
...
- Review Card: [`../reports/game-reviews/stack-tower-2026-07.md`](../reports/game-reviews/stack-tower-2026-07.md)
