...
| Check | How | Expected |
| --- | --- | --- |
| Load | `GET /games/merge-blocks` | 200 |
| Play | 1판 완료 | 점수/결과 표시 |
...
- Review Card: [`../reports/game-reviews/merge-blocks-2026-07.md`](../reports/game-reviews/merge-blocks-2026-07.md)
