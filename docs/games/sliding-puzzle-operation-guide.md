# Sliding Puzzle — Operation Guide
...
| Check | How | Expected |
| --- | --- | --- |
| Load | `GET /games/sliding-puzzle` | 200 |
| Play | 1판 완료 | 점수/결과 표시 |
...
- Review Card: [`../reports/game-reviews/sliding-puzzle-2026-07.md`](../reports/game-reviews/sliding-puzzle-2026-07.md)
