...
import type { SnakeMissionProgress } from "./snake-retention";

export function SnakeMissionHud({ missions }: { missions: SnakeMissionProgress[] }) {
  return (
    <div
      data-testid="snake-mission-hud"
    ...
    >
      <p className="mb-1 font-bold uppercase tracking-widest text-amber-300/90">Missions</p>
      {missions.map((m) => (
