...
const OUT = join(ROOT, "docs/qa/cpo/mp-cpo-2nd-product-qa/mp-experience-73184");
  ...
  if (bomberErr) {
    ...
    if (world) {
      ...
      if (died) {
        ...
        pass("bomber-result", "Result immediately after death");
